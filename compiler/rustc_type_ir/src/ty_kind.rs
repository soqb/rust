...
impl<I: Interner> AliasTy<I> {
    pub fn bounds_instantiated(self, interner: I) -> impl Iterator<Item = I::Clause> {
        self.ctor.bounds(interner).iter_instantiated(interner, self.args)
    }
    pub fn self_bounds_instantiated(self, interner: I) -> impl Iterator<Item = I::Clause> {
        self.ctor.self_bounds(interner).iter_instantiated(interner, self.args)
    }
